...
class Config:
    """
    Class containing the parameters you want to modify for this dataset  网络参数的传入/修改
    """
    ...
    # Architecture definition. List of blocks 会依次读取其中的模块
    architecture = []
    ...
    first_features_dim = 64  # 其实就是相当于之前的维度嵌入
    ...
    first_subsampling_dl = 0.02  # 0.08
    ...
    def load(self, path):
        ...
        # Class variable dictionary  变量存储
        for line in lines:
